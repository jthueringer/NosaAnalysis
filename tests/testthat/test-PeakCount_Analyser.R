test_that("correct calculation, unpaired", {
  ...
  yaml = get_testyaml_object("dir", analyser = "PeakCount", changes = c("DataManipulation$PeakSearchWindow$BeforeStim = 3",
                                                                        "DataManipulation$PeakSearchWindow$AfterStim = 10",
                                                                        "PlotSettings$Paired=FALSE"))
